                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        _buildFormField('student email', Icons.email, largeText: true),
                        SizedBox(height: 10),
                        _buildFormField('hod name', Icons.person, largeText: true),
                        SizedBox(height: 10),
                        _buildFormField('HOD Mail ID', Icons.email),
                        SizedBox(height: 10),
                        _buildFormField('tutor name', Icons.person, largeText: true),
                        SizedBox(height: 10),
